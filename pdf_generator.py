...
def generate_pdf_report(username, data, sheet_number=1):
    sheet_id = f"{sheet_number:03d}"  # Format as 3-digit number
    filename = f"{username}_report_{sheet_id}.pdf"
    ...
    c.drawString(margin, current_y, f"Tax Sheet No: {sheet_id}")
    current_y -= 20
